...
/**
 * Represents a compartment in the inventory that can hold stock items. Each
 * compartment has a name, capacity, allowed special qualities, and a list of
 * stocks currently stored.
 * 
 * @author nj00076
 * @version cs3211
 */
public class Compartment {
	...
	/**
	 * Constructs a Compartment with the given name, capacity, and allowed
	 * qualities.
	 *
	 * @param name             the name of the compartment
	 * @param capacity         the maximum total size of stock that can be stored
	 * @param allowedQualities the special qualities of stock allowed in this
	 *                         compartment
	 */
	...
	/**
	 * Returns the remaining free space in the compartment. Calculated as capacity
	 * minus the sum of sizes of all stored stock.
	 *
	...
	/**
	 * Determines if the given stock can be stored in this compartment. Stock can be
	 * stored if there is enough free space and all its special qualities are
	 * allowed in this compartment.
	 *
